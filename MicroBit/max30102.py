...
class MAX30102(object):
    ...
    def i2c_read_register(self, REGISTER, n_bytes=1):
        self._i2c.write(self.i2c_address, bytearray([REGISTER]))
        return self._i2c.read(self.i2c_address, n_bytes)

    def i2c_set_register(self, REGISTER, VALUE):
        self._i2c.write(self.i2c_address, bytearray([REGISTER, VALUE]))
        return
